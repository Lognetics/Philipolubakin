...
export const sermons = [
  { id: 1, title: 'Anointing of the Spirit', series: 'Holy Spirit', speaker: 'Pastor Philip Olubakin', duration: '52 min', year: 2024, scripture: 'Acts 10:38', featured: true, image: '/images/ministry/hero.jpg' },
  { id: 2, title: 'Living Beyond the Ordinary', series: 'Supernatural', speaker: 'Pastor Philip Olubakin', duration: '48 min', year: 2024, scripture: 'Ephesians 3:20', image: '/images/ministry/preaching-fist.jpg' },
  { id: 3, title: 'The Fire That Never Dies', series: 'Holy Spirit', speaker: 'Pastor Philip Olubakin', duration: '61 min', year: 2023, scripture: 'Leviticus 6:13', image: '/images/ministry/preaching-1.jpg' },
  { id: 4, title: 'Faith That Moves Heaven', series: 'Faith', speaker: 'Pastor Philip Olubakin', duration: '45 min', year: 2024, scripture: 'Hebrews 11:6', image: '/images/ministry/fullbody.jpg' },
  { id: 5, title: 'The School of Prayer', series: 'Prayer', speaker: 'Pastor Philip Olubakin', duration: '55 min', year: 2023, scripture: 'Luke 11:1', image: '/images/ministry/prayer-bow.jpg' },
  { id: 6, title: 'Kingdom Culture', series: 'Kingdom', speaker: 'Pastor Philip Olubakin', duration: '50 min', year: 2024, scripture: 'Matthew 6:33', image: '/images/ministry/preaching-2.jpg' },
  { id: 7, title: 'Building a Marriage That Lasts', series: 'Marriage', speaker: 'Pastors Philip & Funmi', duration: '58 min', year: 2023, scripture: 'Ephesians 5:25', image: '/images/ministry/family-candid.jpg' },
  { id: 8, title: 'The Healer Still Heals', series: 'Healing', speaker: 'Pastor Philip Olubakin', duration: '47 min', year: 2024, scripture: 'Isaiah 53:5', image: '/images/ministry/worship-raised.jpg' },
  { id: 9, title: 'Called to Lead', series: 'Leadership', speaker: 'Pastor Philip Olubakin', duration: '53 min', year: 2023, scripture: 'Nehemiah 2:18', image: '/images/ministry/boardroom.jpg' },
  { id: 10, title: 'Rivers of Living Water', series: 'Holy Spirit', speaker: 'Pastor Philip Olubakin', duration: '49 min', year: 2024, scripture: 'John 7:38', image: '/images/ministry/worship-white.jpg' },
  { id: 11, title: 'Unshakeable', series: 'Faith', speaker: 'Pastor Philip Olubakin', duration: '44 min', year: 2022, scripture: 'Hebrews 12:28', image: '/images/ministry/worship-sing.jpg' },
  { id: 12, title: 'The Supernatural Church', series: 'Supernatural', speaker: 'Pastor Philip Olubakin', duration: '56 min', year: 2024, scripture: 'Acts 2:42', image: '/images/ministry/congregation-1.jpg' },
];
